...
<link rel="icon" type="image/png" href="{{ asset('img/logo.smk.png') }}">
    ...
    <style>
        ...
        * {
        ...
        /* TABLET / LAYAR SEDANG: statistik jadi 2 kolom */
        ...
        @media (max-width: 768px) {
            ...
            /* Filter panel: search & select jadi lebar penuh, tombol lebih ringkas */
            .filter-panel {
                padding: 14px;
            }
        ...
        /* LAYAR SANGAT KECIL (HP KECIL): statistik jadi 1 kolom */
                ...
                <div class="filter-top-row">
                    ...
                    <div class="filter-group">
                        <select class="select-filter" id="filterStatus" onchange="filterData()">
                            ...
                            <option value="lengkap">Berkas Diverifikasi</option>
                            <option value="menunggu">Sedang Diproses</option>
                            <option value="kurang">Pending / Belum Lengkap</option>
    ...
    <script>
        ...
        function filterData() {
            ...
            const filtered = dataPendaftar.filter(siswa => {
                ...
                // Cocokkan langsung ke nilai status asli dari database (status_verifikasi / status_seleksi),
                // bukan ke teks label yang tampil di badge, supaya filter selalu akurat.
                let matchStatus = true;
                if (filterStatus === "lulus") {
                    matchStatus = (siswa.statusSeleksi || '').toLowerCase() === 'lulus';
                } else if (filterStatus === "kurang") {
                    matchStatus = siswa.status === 'kurang' || siswa.status === 'ditolak';
                } else if (filterStatus !== "") {
                    matchStatus = siswa.status === filterStatus;
                }
