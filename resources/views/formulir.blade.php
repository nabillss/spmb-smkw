    ...
    <style>
        ...
        * {
        ...
        .form-grid > .form-group {
            min-width: 0; /* cegah 1 kolom "merebut" ruang kolom sebelahnya */
        }
        .form-group {
            display: flex;
            flex-direction: column;
        ...
        .form-row-split > select {
            min-width: 0; /* cegah kolom Tempat Lahir / Tinggi / RT menyusut tidak merata */
        }
        ...
        @media (max-width: 768px) {
            ...
            /* --- FIX: form tidak sempit di HP, tetap 2 kolom sejajar & sama lebar --- */
            body {
            ...
            .form-grid {
                gap: 18px 14px; /* jarak antar kolom dipersempit supaya 2 kolom tetap muat */
            }
            .form-group label {
                font-size: 11px;
            }
            ...
            /* Khusus Tempat Lahir & Tanggal Lahir: ditumpuk, tempat di atas, tanggal di bawah */
            .form-row-split.birth-split {
            ...
            <form id="formPendaftaran" action="{{ url('/daftar') }}" method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row-split birth-split">
                            <input type="text" id="input_tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir') }}" placeholder="Tempat Lahir" required>
                    ...
                    <div class="form-group">
                        <label>Nilai Rata-rata Raport<span>*</span></label>
                        <input type="number" id="input_nilai_rata_rata" name="nilai_rata_rata" value="{{ old('nilai_rata_rata') }}" step="0.01" min="0" max="100" placeholder="cth. 85.50" required>
                    </div>
