        ...
        <div class="content-body">
            <div class="panel">
                ...
                <div class="section">
                    ...
                    <div class="grid-2">
                        <div class="field-list">
                            ...
                            @php
                                $tempatLahir = $pendaftar->tempat_lahir ?? null;
                                $tglLahirFormatted = $pendaftar->tanggal_lahir ? \Carbon\Carbon::parse($pendaftar->tanggal_lahir)->format('d M Y') : null;
                                $ttl = ($tempatLahir && $tglLahirFormatted) ? "{$tempatLahir}, {$tglLahirFormatted}" : ($tempatLahir ?: ($tglLahirFormatted ?: '-'));
                            @endphp
                            <div class="field"><span class="field-label">Tempat, Tanggal Lahir</span><span class="field-sep">:</span><span class="field-val" id="val_ttl">{{ $ttl }}</span></div>
                ...
                <div class="section">
                    ...
                    @php
                        $isGel2 = str_contains(strtolower($pendaftar->gelombang ?? ''), '2');
                        $metode = strtolower($pendaftar->metode_pembayaran ?? '');
                        $metodeText = 'Belum Dipilih';
                        if ($metode === 'transfer') {
                            $metodeText = 'Transfer Bank';
                        } elseif (in_array($metode, ['langsung', 'cash'])) {
                            $metodeText = 'Bayar Langsung / Tunai';
                        }
                    @endphp
                    <div class="grid-3">
                        ...
                        <div class="jurusan-card"><div class="jurusan-eyebrow">Gelombang</div><div class="jurusan-code" id="val_gelombang2">{{ $pendaftar->gelombang ?? '-' }}</div></div>
                    </div>
                    <div class="field-list" id="metodePembayaranRow" style="margin-top: 12px; display: {{ $isGel2 ? 'block' : 'none' }};">
                        <div class="field"><span class="field-label">Metode Pembayaran (Gel. 2)</span><span class="field-sep">:</span><span class="field-val" id="val_metodePembayaran">{{ $metodeText }}</span></div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="field-list">
                        ...
                        <div class="field"><span class="field-label">Nilai Rata-rata Raport</span><span class="field-sep">:</span><span class="field-val" id="val_nilaiRataRata">{{ $pendaftar->nilai_rata_raport ?? '-' }}</span></div>
                    </div>
                </div>
