  ...
  <main class="main" id="mainContent">
    ...
    <form id="editForm" onsubmit="return false;">
      ...
      <div class="section">
        ...
        <div class="row-1">
          <div class="field"><label>Nilai Rata-rata Raport<span class="req">*</span></label><input type="number" id="input_nilaiRataRata" class="req" step="0.01" min="0" max="100" placeholder="cth. 85.50" value="{{ $pendaftar->nilai_rata_raport ?? '' }}"></div>
        </div>
        ...
        <div class="row-2">
          <div class="field">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
              <input type="text" id="input_tempatLahir" class="req" placeholder="Tempat Lahir" value="{{ $pendaftar->tempat_lahir ?? '' }}">
              <input type="date" id="input_tglLahir" class="req" value="{{ $pendaftar->tanggal_lahir ? \Carbon\Carbon::parse($pendaftar->tanggal_lahir)->format('Y-m-d') : '' }}">
            </div>
          </div>
          <div class="field">
...
document.getElementById("btnSimpan").addEventListener("click", async () => {
  ...
  const payload = {
    ...
    nilai_rata_raport: document.getElementById('input_nilaiRataRata').value.trim(),
