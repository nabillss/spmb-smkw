            ...
            <div class="panel">
                ...
                <div class="section">
                    ...
                    <div class="grid-2">
                        <div class="field-list">
                            ...
                            <div class="field"><span class="field-label">Tempat, Tanggal Lahir</span><span class="field-sep">:</span><span class="field-val" id="val_ttl">{{ $pendaftar->tempat_lahir ?? '-' }}, {{ $pendaftar->tanggal_lahir ? \Carbon\Carbon::parse($pendaftar->tanggal_lahir)->format('d M Y') : '-' }}</span></div>
                ...
                <div class="section" style="margin-bottom: 0;">
                    ...
                    <div class="field-list">
                        ...
                        <div class="field"><span class="field-label">Nilai Rata-rata Raport</span><span class="field-sep">:</span><span class="field-val" id="val_nilaiRataRata">{{ $pendaftar->nilai_rata_rata ?? '-' }}</span></div>
                    </div>
                </div>
