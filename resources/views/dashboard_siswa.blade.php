...
<body>
        ...
        <div class="content-body">
            ...
            <div class="card">
                ...
                <div class="stepper-container">
                    ...
                    <div class="step-item {{ optional($pendaftar)->status_verifikasi == 'lengkap' || optional($pendaftar)->status_seleksi == 'Lulus' ? 'completed' : '' }}" id="step4">
                    ...
                    <div class="step-item {{ optional($pendaftar)->status_seleksi == 'Lulus' ? 'completed' : '' }}" id="step5">
                        <div class="step-icon">5</div>
                        <div class="step-label">5. Pengumuman</div>
                        <div class="step-date" id="dateStep5">{{ optional($pendaftar)->status_seleksi == 'Lulus' ? 'Lulus' : '-' }}</div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const STATUS_PENDAFTARAN_SERVER = "{{ optional($pendaftar)->status_seleksi ?? '' }}";
        ...
        window.addEventListener("storage", function(e) {
            if (e.key === "list_pendaftar" || (e.key && e.key.indexOf("berkas_pendaftar_") === 0) || e.key === "status_verifikasi_admin") {
                loadProfileData();
            }
        });
        ...
        // Reset state saat ukuran layar berpindah lintas breakpoint 992px
